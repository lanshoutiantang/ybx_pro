...
class Feature(SubModule):
    def __init__(self):
        ...
        mobilenetv2_file_path = os.path.join(
            os.path.dirname(current_file_path),
            "mobilenetv2_100_ra-b33bc2c4_timm054.pth",
        )

        config = _cfg(url="", file=mobilenetv2_file_path)
        ...
        self.conv8 = BasicConv_IN(
            chans[2] * 2, chans[2] * 2, kernel_size=3, stride=1, padding=1
        )
