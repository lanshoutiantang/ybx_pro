...
if __name__ == '__main__':
    ...
    outer_path = r'D:\桌面\UBT\2024\bev\1.2.2xin\jieguo\acc'
    ...
    for filename in filelist:
        ...
        with open(file_path, "r") as f:
            ...
            # 1.2.9版本之后加上了agv类别，将79改成了84
            # 1.3.0版本之后每类加上三个指标之后，将84改成84+15*3=129
            # 1.4.0版本之后加上了三轮车类别，将129改成了137，一共16个类别
            # 1.5.0版本之后是17个类别，将137改成了145
            # while col < 74:
            print("开始")
            while col < 145:
                right = col - 9
            ...
            print(df_df)
            # 调换顺序
            df_df = df_df.iloc[[0, 1, 6, 8, 5, 3, 7, 4, 9, 10, 11]]
            # #----------------------------------------
