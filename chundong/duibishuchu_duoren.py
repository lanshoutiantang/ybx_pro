...
def shuchu(df, df1):
    ...
    while i < len(df):
        ...
        while j < len(df1):
            ...
            biduishu_id = df1.iloc[j,3]
            # print(type(int(biduishu_id)))
            # print(id, int(biduishu_id))
            if biduishu < left:
                j = j + 1
                continue
            if biduishu > right:
...
if __name__ == '__main__':
    ...
    # 使用pandas读取txt文件
    df = pd.read_csv(r'C:\Users\ming.liu\Desktop\duoren\26.txt', delimiter=' ', names=['0', '1', '2'], )
    # print(df)
    # print(df.iloc[1, 1])
    # print(len(df))
    df1 = pd.read_csv(r'C:\Users\ming.liu\Desktop\shuzi\26.txt', delimiter='\t', names=['0', '1', '2'], )
    # print(df1)
    # print(df1.iloc[1, 1])
    print("算法")
    diyi, dier = re.split("-", df1.iloc[0, 0])
    df1['3'] = df1['0'].apply(lambda x: re.split(":", re.split("-", x)[0])[1])
    # print(diyi, dier)
    df['1'] = df['1'].astype(int)
    df1['3'] = df1['3'].astype(int)
    # df.to_excel(r'C:\Users\ming.liu\Desktop\duoren\duoren26.xlsx')
    # print(df1.dtypes)
    # print(df.dtypes)
    sumwenjianshu = 0;
    ...
    for i in range(26, 50):
        # print(i)
        string1 = r'C:\Users\ming.liu\Desktop\duoren\{}.txt'.format(i)
        ...
        try:
            with open(path1, 'r') as file:
                ...
                # 在这里处理文件内容
                df = pd.read_csv(path1, delimiter=' ', names=['0', '1', '2'], )
